...
$VSTORE_TEMPLATE['cat']['item']   = '
		...
		<div class="vstore-category-list col-sm-4 col-lg-4 col-md-4 card">
			<div class="img-thumbnail card-body">
 ...
 * Product list
 */
$VSTORE_TEMPLATE['list']['start']   = '<div class="row"><div class="col-md-12"><h2>{CAT_NAME}<small>{CAT_DESCRIPTION}</small></h2>{CAT_INFO}</div>';
$VSTORE_TEMPLATE['list']['item']    =  '
{SETIMAGE: w=320&h=320&crop=1} 										           										
<div class="vstore-product-list col-lg-4 col-md-6 mb-4 ">							                        
	<div class="card h-100">							                          
		<a href="{ITEM_URL}">{ITEM_PIC}</a>  								                        
		<div class="card-body">								                                            
			<h4 class="card-title">                  
				<a href="{ITEM_URL}">{ITEM_NAME}</a>                </h4>								 <h5>{ITEM_PRICE}</h5>								 
			<p class="card-text">{ITEM_DESCRIPTION: limit=150}{ITEM_VARS}
			</p>     
				                         								                                                
 			{ITEM_ADDTOCART: class=btn btn-sm btn-secondary vstore-add&class0=btn btn-sm btn-default disabled vstore-add}	
			 	</div>   					  								
			<div class="card-footer">                
						                          <!--
						                            <div class="ratings">
						                                <p class="float-left">15 reviews</p>
														<p  class="float-right">
...
$VSTORE_TEMPLATE['menu']['item'] =  '
			...
			<div class="vstore-product-list">
					<div class="caption">
						<div class="row">
							<a href="{ITEM_URL}" class="col-4 col-sm-4">{ITEM_PIC}</a>
							<h4 class="col-8 col-sm-8"><a href="{ITEM_URL}">{ITEM_NAME}</a></h4>
						</div>
						...
						<div class="row">
							...
							<div class="col-12 col-sm-7 text-right">
								{ITEM_ADDTOCART: class=btn btn-sm btn-secondary vstore-add&class0=btn btn-sm btn-default disabled}
							</div>
						</div>
				</div>
			</div>';
...
{SETIMAGE: w=72&h=72&crop=1}
	<tr>
		<td>
			<div class="media">
				<div class="text-left">
					<a href="{ITEM_URL}">{ITEM_PIC: class=mr-3 media-object}</a>
				</div>
				<div class="media-body">
					<h4 class="media-heading mt-0"><a href="{ITEM_URL}">{ITEM_NAME}</a></h4>
					 by <a href="{ITEM_BRAND_URL}">{ITEM_BRAND}</a> 
					{ITEM_VAR_STRING}
				</div>
			</div>
		</td>
		<td class="text-center">{CART_REMOVEBUTTON}</td>
		<td class="text-center">{CART_VARS}{CART_QTY=edit} </td>
		<td class="text-right">{CART_PRICE}</td>
